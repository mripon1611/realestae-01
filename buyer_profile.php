	...
	<body>
        <table border="0" width="100%" height="25px">
            <tr> 
                ...
                <td width="10%">
		            <a href="buyer_profile.php"><input class="profile" type="button" value="PROFILE"></a>
                </td>
                <td width="10%">    
		...
		<table border="0" width="80%" height="570px"  align="right"> 
            ...
            <tr>
                <td>&nbsp;</td>
                <td align="right"><a href="editprofile.php"><input type="button" value="Edit Profile"></a></td>
            </tr>
            <tr>
