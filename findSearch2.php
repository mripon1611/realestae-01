    ...
    <body>
        ...
        <table border="0" width="100%" height="25px">
            <tr> 
                ...
                <td width="10%">
                    <a href="userHome.php"><input class="bb" type="button" value="BUYER"></a>
                </td>
                <td width="10%">
        ...
        <table border="0" width="100%" height="62px">
            ...
            <tr>
                ...
                <h4>If you want expacted land,you may <a href="RequestPage.php"><input type="button" class="bb" value="FILL UP"></a> a form</h4>
                </td>
            </tr>
        </table>
